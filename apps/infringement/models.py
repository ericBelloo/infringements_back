...
from apps.address.models import Postcodes, Colonies
...
class Infringements(models.Model):
    folio = models.CharField(max_length=20, null=False, blank=False, unique=True)
    ...
    driver = models.ForeignKey(Drivers, null=True, blank=True, on_delete=models.SET_NULL)
